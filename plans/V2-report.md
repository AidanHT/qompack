...
| V2-MERGE-05 | `importrules.go` covers every landed package + three new composition roots | PASS | all wave-1 pkgs + test/dedup + test/bench/hotpath + test/replay present at cut; test/integration added as the eighth root in df2ff6a (§4.8); sketch still {core,paths,logging} |
